...
def index():
    ...
    cur.close()
    return render_template('home.html', tshirt=tshirt, form=form)
...
class RegisterForm(Form):
    ...
    password = PasswordField('', [validators.length(min=5)],
                             render_kw={'placeholder': 'Password'})
    mobile = StringField('', [validators.length(min=10, max=13)], render_kw={'placeholder': 'Mobile'})
